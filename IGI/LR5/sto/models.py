...
class Supplier(models.Model): 
    ...
    cars = models.ManyToManyField('Cars', related_name="supplier", through='Supply')
...
class Supply(models.Model):
    ...
    car = models.ForeignKey('Cars', related_name="supply", on_delete=models.CASCADE)
...
class Cars(models.Model):
    ...
    categories = models.ForeignKey(Categories, related_name="cars", on_delete=models.CASCADE)
...
class DepartmentCar(models.Model):
    department = models.ForeignKey(Department, on_delete=models.CASCADE)
    car = models.ForeignKey(Cars, on_delete=models.CASCADE)
    quantity = models.PositiveIntegerField(default=0)

    def __str__(self):
        return f"{self.car.name} - {self.department.no} ({self.quantity})"
...
class Sale(models.Model):
    ...
    car = models.ForeignKey(Cars, related_name="items", on_delete=models.CASCADE)
    ...
    def subtotal(self):
        subtotal = self.quantity * self.car.cost
        return subtotal
